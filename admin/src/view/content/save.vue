<template>
    <Form :model="formItem"  ref="formItem" :rules="ruleInline" :label-width="80">
        <FormItem label="动态标题"  prop="title">
            <Input v-model="formItem.title" placeholder="动态标题"></Input>
        </FormItem>
        <FormItem label="动态标识"  prop="slug">
            <Input v-model="formItem.slug" placeholder="动态唯一标识，并作为参数构造url"></Input>
        </FormItem>
        <FormItem label="位置"  prop="category_id">
