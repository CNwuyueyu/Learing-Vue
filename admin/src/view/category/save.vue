<template>
    <Form ref="formItem" :model="formItem" :label-width="80" :rules="ruleInline">
        <FormItem label="位置名称"  prop="name">
            <Input v-model="formItem.name" placeholder="位置名称"></Input>
        </FormItem>
        <FormItem label="缩略名">
        ...
        <FormItem label="位置描述">
            <Input v-model="formItem.description" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="此文字用于描述位置, 预置参数"></Input>
        </FormItem>
        <FormItem>
