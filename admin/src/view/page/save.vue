<template>
  <Form :model="formItem" ref="formItem" :rules="ruleInline" :label-width="80">
    <FormItem label="店铺名称" prop="title">
      <Input v-model="formItem.title" placeholder="输入店铺名称"></Input>
    </FormItem>
    <FormItem label="店铺标识" prop="slug">
      <Input v-model="formItem.slug" placeholder="店铺唯一标识，并作为参数构造url"></Input>
    </FormItem>
    <FormItem label="内容编辑">
      <div id="editor">
